...
for testcase in test:
    ...
    if(p1>p2):
        if p1>p3:
            code = 1
            #print 'Woah! This one is setosa'
        else:
            code = 3
            #print 'Woah! This one is Virginica'
    else:
        if p2>p3:
            code = 2
            #print 'Woah! This one is Versicolour'
        else:
            code = 3
            #print 'Woah! This one is Virginica'
    ...
    if testcase[4]==str(code):
        accuracy += 1
#    print str(code) + ' ' + str(testcase[4]) + ' ' + str(accuracy)
